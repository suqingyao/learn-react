export const getMaskStyle = (element: HTMLElement, container: HTMLElement) => {
  ...
  return {
    ...
    borderBottomWidth: Math.max(container.scrollHeight - elementTopWithScroll - height, 0),
    borderRightWidth: Math.max(container.scrollWidth - elementLeftWithScroll - width, 0)
  };
};
